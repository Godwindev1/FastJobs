...
public sealed class SystemHealthModel
{
    ...
    public IReadOnlyList<QueueDepthModel> Queues { get; init; } = Array.Empty<QueueDepthModel>();
    public IReadOnlyList<ServerModel> Servers   { get; init; } = Array.Empty<ServerModel>();
